...
use Modules\User\Http\Requests\Auth\LoginRegisterRequest;
use Modules\User\Http\Services\Message\Email\EmailService;
use Modules\User\Http\Services\Message\MessageService;
use Modules\User\Http\Services\Message\SMS\SmsService;
...
class LoginRegisterController extends Controller
{
    ...
    public function checkEmailOrMobile($emailOrMobile)
    {
        ...
        {
            $type = 1 ; // 1 =>email
            $user = $this->userRepo->findOrCreateUserByEmail($emailOrMobile);
