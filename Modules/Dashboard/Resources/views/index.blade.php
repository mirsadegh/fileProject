...
@section('content')
 @can(\Modules\RolePermission\Entities\Permission::PERMISSION_TEACH)
            ...
            <table width="100%" class="table">
                ...
                <tbody>
                    ...
                    <tr role="row" class="">
                        ...
                        <td class="@if($payment->status == \Modules\Payment\Entities\Payment::STATUS_SUCCESS) text-success @else text-error @endif">@lang($payment->status)</td>
                    </tr>
                @endforeach
