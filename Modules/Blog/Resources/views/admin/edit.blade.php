...
@section('content')
    <div class="main-content padding-0">
        ...
        <div class="row no-gutters bg-white">
            <div class="col-12">
                <form action="{{ route('blogs.admin.update', $blog->id) }}" method="post"class="padding-30" id="form"
                    ...
                    <div class="row">
                        ...
                        <section class="col-12  mb-4">
                            <div class="form-group">
                                ...
                                <select name="status" id="status" class="">
                                    <option value="0" @if (old('status', $blog->status) == 0) selected @endif>غیر فعال
                                    </option>
                        ...
                        <section class="col-12  mb-4">
                            <div class="form-group">
                                ...
                                <select name="commentable" id="commentable" class="">
                                    <option value="0" @if (old('commentable', $blog->commentable) == 0) selected @endif>غیر فعال
                                    </option>
                                    <option value="1" @if (old('commentable', $blog->commentable) == 1) selected @endif>فعال</option>
                                </select>
                            </div>
                        ...
                        <section class="col-12 mb-5">
                            <div class="form-group">
                                ...
                                <input type="text" id="published_at_view" class="form-control form-control-sm text"
                                    style="margin-top: 0">
                            </div>
                            @error('published_at')
                                <span class="invalid-feedback" role="alert">
                            ...
                            @enderror
                            <p> {{ \Morilog\Jalali\Jalalian::forge($blog->published_at) }} </p>
                        </section>
                        <x-file placeholder="آپلود بنر دوره" name="image" :value="$blog->media" />

                        <section class="col-12 my-4">
                            <div class="form-group">
                                <label for="tags">تگ ها</label>
                                <input type="hidden" name="tags" id="tags" value="{{ old('tags', $blog->tags) }}">
                        ...
                        <section class="col-12 mb-3">
                            <div class="form-group">
                                ...
                                <textarea name="summary" id="summary" class="form-control form-control-sm" rows="6">{{ old('summary', $blog->summary) }}</textarea>
                            </div>
                            @error('summary')
                                <span class="invalid-feedback" role="alert">
                                    <strong>
                        ...
                        <section class="col-12 mb-4">
                            <div class="form-group">
                                ...
                                <textarea name="body" id="body" class="form-control form-control-sm" rows="6">{{ old('body', $blog->body) }}</textarea>
                            </div>
                            @error('body')
                                <span class="invalid-feedback" role="alert">
                                    <strong>
