    ...
    <div class="container">
        <div class="t-header-row">
            ...
            <div class="t-header-left">
                        ...
                        <div class="user-menu-account">
                            ...
                            <div class="user-menu-account-dropdown">
                                <ul>
                                    ...
                                    <li>
                                        <a href="#" onclick="event.preventDefault();document.getElementById('logout').submit();">خروج</a>
                ...
                @else
                        <div><a class="btn-register" href="{{ route('auth.login-register-form') }}">ثبت نام / ورود</a></div>
